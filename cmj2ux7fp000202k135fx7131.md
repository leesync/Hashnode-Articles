...
Further reading around costs in architectures and where you can look to improve saving money can be explored here: [Where the pennies hide in the architecture](https://substack.com/@architectsassemble/p-171979930)
...
If you are learning how to architect in AWS you can follow our series on learning how to architect systems in financial services. [Learn how to architect tomorrow's financial systems](https://architectsassemble.substack.com/) .

An audit of your infrastructure with a [Free Cloud Assessment](https://www.syncyourcloud.io/) provides a roadmap to running cloud infrastructure without waste.